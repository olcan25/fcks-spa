...
@Component({
  selector: 'app-update-lines-import-goods',
  templateUrl: './update-lines-import-goods.component.html',
  styleUrls: ['./update-lines-import-goods.component.css']
})
export class UpdateLinesImportGoodsComponent implements OnInit {
  ...
  openCreateModal() {
    const modalRef = this.modalService.open(UpdateLinesImportGoodsComponent, {
      backdrop: 'static',
      keyboard: true,
    });
