...
import { CreateHeadImportGoodsComponent } from '../create-head-import-goods/create-head-import-goods.component';

@Component({
  selector: 'app-create-lines-import-goods',
  templateUrl: './create-lines-import-goods.component.html',
  styleUrls: ['./create-lines-import-goods.component.css']
})
export class CreateLinesImportGoodsComponent implements OnInit {
  ...
  openCreateModal() {
    const modalRef = this.modalService.open(CreateHeadImportGoodsComponent, {
      backdrop: 'static',
      keyboard: true,
    });
